...
// Handles AdminUserUsageViewModel for this part of the statistics page.
// This makes the purpose clearer when reading or updating the code.
class AdminUserUsageViewModel extends ChangeNotifier {
  final GetAdminUserUsageStatisticsUseCase _getStatisticsUseCase;
  ...
  AdminUserUsageViewModel({
    required GetAdminUserUsageStatisticsUseCase getStatisticsUseCase,
